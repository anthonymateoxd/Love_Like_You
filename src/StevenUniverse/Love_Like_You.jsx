...
function Love_Like_You() {
  const lyrics = [
    ...
    { text: 'Wondering when Im coming back', start: 22.1, end: 24.7 },
    ...
    { text: 'Now Im sure that its true', start: 57.4, end: 60.4 },
    { text: 'Cause I think youre so good', start: 60.5, end: 64.0 },
    { text: 'And Im nothing like you', start: 64.1, end: 66.4 },
    ...
    { text: 'What makes you think Im so special', start: 73.1, end: 79.5 },
